...
export default function WeddingJourney() {
  return (
    <section className="py-20 bg-linear-to-b from-[#fff7fa] to-[#fff1f6] flex flex-col items-center justify-center -mx-4 sm:-mx-6 lg:-mx-8 px-4 sm:px-6 lg:px-8">
      ...
      {/* Action Button */}
      <Link href="/journey" className="px-10 py-5 bg-linear-to-r from-[#e7477b] to-[#fb6c98] text-white rounded-full font-bold text-lg shadow-[0_20px_40px_rgba(255,79,134,0.35)] hover:shadow-[0_25px_50px_rgba(255,79,134,0.45)] hover:-translate-y-1 transition-all duration-300 flex items-center gap-4">
